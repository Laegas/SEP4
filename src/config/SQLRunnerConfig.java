...
public class SQLRunnerConfig {
    // DWH Course resource
    public static final File COURSE_RESOURCE_DDL = new File
            ("src/database/ETL/DWHCourse/resource/DDLForOperationalSystems.sql");
    public static final File COURSE_RESOURCE_REGIONSCLUBSMEMBERS = new File
            ("src/database/ETL/DWHCourse/resource/RegionsClubsMembers.sql");
    public static final File COURSE_RESOURCE_FLIGHTS = new File
            ("src/database/ETL/DWHCourse/resource/flights.sql");
    ...
    public static final File WEATHER_AFTER_ETL = new File("src/database/ETL/weather/runAfterETL/afterETLWeather.sql");
    ...
    // Utility
    public static final File PROCEDURES = new File("src/database/DDL/procedures.sql");
}
