...
BEGIN
  ...
  EXECUTE IMMEDIATE 'drop table D_IGC_WEATHER CASCADE CONSTRAINTS purge';
...
create table D_IGC_WEATHER (
  surr_key_igc_weather int PRIMARY KEY
);
...
CREATE table F_IGC_LOG(
  ...
  gps_altitude INT,
  gps_ok char(1),
  PRIMARY KEY (surr_key_log,surr_key_flight,surr_key_glider, surr_key_igc_weather)
);
