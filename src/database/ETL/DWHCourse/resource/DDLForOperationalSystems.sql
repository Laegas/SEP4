...
BEGIN DROP_TABLE('taFlightsVejle'); END;
BEGIN DROP_TABLE('taFlightsSG70'); END;
BEGIN DROP_TABLE('taMember'); END;
BEGIN DROP_TABLE('taClub'); END;
BEGIN DROP_TABLE('taRegion'); END;
